...
void PrepareTestData(vector<TD_VI_VI_T>& testData)
{
    ...
    data.output = GenerateTree({ 7,-10,2,-4,3,-8,NULL,NULL,NULL,NULL,-1,11 });
    ...
    data.input = { 1, 2, 3 };
    data.input2 = { 2, 3, 1 };
    data.output = GenerateTree({ 1,2,NULL, NULL, 3 });
    testData.push_back(data);

    data.input = { 1, 2, 3 };
    data.input2 = { 3, 2, 1 };
    data.output = GenerateTree({ 1,2,NULL,3 });
    testData.push_back(data);

    data.input = { 1, 2 };
    data.input2 = { 1, 2 };
    data.output = GenerateTree({ 1, NULL, 2 });
    testData.push_back(data);
